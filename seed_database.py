...
def run_seed():
    print("Seeding database with realistic electronics store data & online HD images...")
    ...
    demo_user, _ = User.objects.get_or_create(
        username='johndoe',
        defaults={'first_name': 'John', 'last_name': 'Doe', 'email': 'john.doe@example.com'}
    )
    ...
    # 3. Setup Products with high-resolution online product URLs
    products_data = [
        {
    ...
    testimonials_data = [
        {
            ...
            "content": "Nexus has the best collection of gadgets. Fast delivery, great prices and amazing customer service! My MacBook Air arrived in pristine condition."
        },
        {
    ...
    print("\nDatabase seeded with online image assets successfully!")
